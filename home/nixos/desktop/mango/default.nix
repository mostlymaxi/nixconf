...
with lib;
{
  ...
  config = mkIf osConfig.desktop.mango.enable {
    xdg.configFile."mangowc/config.conf".text = ''
      bind=SUPER,Return,spawn,${config.terminal.exec}
      bind=SUPER,d,spawn,${config.launcher.exec}
